...
class TrayIcon:
    ...
    def set_opacity(self, opacity):
        self.kl.config.opacity = opacity
        self.kl.config.save()

    def toggle_notifications(self):
        self.kl.config.notifications_enabled = not self.kl.config.notifications_enabled
        self.kl.config.save()
    ...
    def create_tray_icon(self):
        ...
        menu = Menu(
            ...
            MenuItem("Change Hotkey", self.kl.send_change_hotkey_signal),
            MenuItem(
                "Enable/Disable Notifications",
                self.toggle_notifications,
                checked=lambda item: self.kl.config.notifications_enabled,
            ),
            ...
            MenuItem("Quit", self.kl.quit_program),
        )
